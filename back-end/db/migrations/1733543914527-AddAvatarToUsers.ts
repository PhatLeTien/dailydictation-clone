...
export class AddAvatarToUsers1733543914527 implements MigrationInterface {
    name = 'AddAvatarToUsers1733543914527'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`avatar\` varchar(500) NULL`);
