  ...
  return (
    <main className={`container mx-auto px-4 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'} min-h-screen`}>
      <section className="text-left py-8 w-1/3">
        <h1 className="text-[2.5rem] font-medium mb-4">Practice English with dictation exercises</h1>
        <p className="mb-4">Dictation is a method to learn languages by listening and writing down what you hear. With these challenges, you'll practice with curated YouTube videos using subtitles for effective learning!</p>
        <p className="mb-4">Take part in different challenges ranging from 3 to 15 days to sharpen your listening and comprehension skills.</p>
        <button className="bg-[#6ea8fe] text-white px-6 py-2 rounded">Start Challenge</button>
        <span className="ml-2">- It's 100% FREE!</span>
      </section>
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="flex flex-col items-start text-start">
            <div>
              <h3 className="font-medium mb-2 text-[1.75rem]">Is this program free?</h3>
          ...
          <div className="flex flex-col items-start text-start">
            <div>
              <h3 className="font-medium mb-2 text-[1.75rem]">Is this website for beginners?</h3>
              <p>As long as you can understand this page, you're good to go! But it's better if you know basic English pronunciation, if you don't, watch this  <span className="text-[#6ea8fe] underline">YouTube series.</span></p>
            </div>
          </div>

          <div className="flex flex-col items-start text-start">
            <div>
              <h3 className="font-medium mb-2 text-[1.75rem]">How long will it take to become fluent with this website?</h3>
