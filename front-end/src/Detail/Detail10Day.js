...
const data = [
  ...
  { id: 4, title: "Day 4 - Video" },
  { id: 5, title: "Day 5 - Video" },
  { id: 6, title: "Day 6 - Video" },
  { id: 7, title: "Day 7 - Video" },
  { id: 8, title: "Day 8 - Video" },
  { id: 9, title: "Day 9 - Video" },
  { id: 10, title: "Day 10 - Video" },
];
  ...
  return (
    <div className="p-5">
      {selectedItem ? (
        ...
        <>
          <h2 className="text-2xl font-semibold mb-4">10-Day IELTS Prep</h2>
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              <input
                type="text"
